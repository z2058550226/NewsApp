        ...
        if (sDlPhotos.get(url.hashCode(), false)) {
            DialogHelper.deleteDialog(context, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    FileUtils.deleteFile(PreferencesUtils.getString(context, SettingsFragment.SAVE_PATH_KEY, SettingsFragment.DEFAULT_SAVE_PATH) + File.separator + id + ".jpg");
        ...
        Observable.just(url)
                ...
                .map(new Func1<String, Boolean>() {
                    ...
                    public Boolean call(String s) {
                        ...
                        return FileUtils.copyFile(file.getPath(), PreferencesUtils.getString(context, SettingsFragment.SAVE_PATH_KEY, SettingsFragment.DEFAULT_SAVE_PATH) +
