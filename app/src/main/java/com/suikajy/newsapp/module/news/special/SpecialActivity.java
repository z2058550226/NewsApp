...
import com.suikajy.newsapp.injector.components.DaggerSpecialComponent;
...
public class SpecialActivity extends BaseSwipeBackActivity<IBasePresenter> implements ISpecialView {
    ...
    private void _handleTagLayout(List<SpecialItem> specialItems) {
        ...
        Observable.from(specialItems)
                .compose(this.<SpecialItem>bindToLife())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .filter(new Func1<SpecialItem, Boolean>() {
                    int i = 0;
                    int index = mSpecialAdapter.getHeaderViewsCount();
        ...
        mTagLayout.setTagClickListener(new TagView.OnTagClickListener() {
            ...
            public void onTagClick(int i, String s, int i1) {
                ...
                mLayoutManager.scrollToPositionWithOffset(mSkipId[i], 0);
            }
        });
    }
