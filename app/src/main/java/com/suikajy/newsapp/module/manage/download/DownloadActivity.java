...
import com.suikajy.newsapp.injector.components.DaggerDownloadComponent;
...
import com.suikajy.newsapp.rxbus.event.VideoEvent;
import com.suikajy.newsapp.widget.FlexibleViewPager;
...
public class DownloadActivity extends BaseActivity<IRxBusPresenter> {
    ...
    @OnClick({R.id.tv_close_edit, R.id.btn_select_all, R.id.btn_select_del})
