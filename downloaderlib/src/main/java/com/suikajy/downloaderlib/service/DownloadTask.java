package com.suikajy.downloaderlib.service;

import android.os.Process;
import android.os.SystemClock;
import android.util.Log;

import com.suikajy.downloaderlib.DownloadListener;
import com.suikajy.downloaderlib.db.FileDAOImpl;
import com.suikajy.downloaderlib.entity.FileInfo;
import com.suikajy.downloaderlib.exception.DownloadException;
import com.suikajy.downloaderlib.model.DownloadStatus;
import com.suikajy.downloaderlib.model.FileUtils;
...
public class DownloadTask implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            // 3.初始化请求
            Log.e("********SUIKAJY********","3.初始化请求");
            Request request = requestBuilder.build();
            call = mClient.newCall(request);

            // 4.执行请求
            Log.e("********SUIKAJY********","4.执行请求");
            ...
            if (isSucceedResume || isSucceedStart) {
                ...
                // 6.网络状态已连接
                Log.e("********SUIKAJY********","6.网络状态已连接");
                _onConnected();
                // 7.开始获取数据
                Log.e("********SUIKAJY********","7.开始获取数据");
    ...
    private void _onDownload(Response response) throws Throwable {
        ...
        Log.e("********SUIKAJY********",mFileInfo.getPath() + mFileInfo.getName());
        ...
        Log.e("********SUIKAJY********",mFileInfo.getPath());
